...
public class OperandFetch {
	...
	public static int get_inst_code(Instruction inst) {
	...
	public static boolean checkError(Instruction inst, int r1, int r2)
	{
		int arg_code = get_inst_code(inst);
	...
	public static boolean checkDivOP(int code) {
		if (code == 6 || code == 7)
			return true;
	...
	public boolean checkErrorWithDivision(int r1, int r2) 
	{
		...
		if (r1 == 31 || r2 == 31)
		{
			...
			return checkDivOP(ex_code) || checkDivOP(ma_code) || checkDivOP(rw_code);
		}

		return false;
	}
	
	public void modifyIfError() {
		...
		if(IF_OF_Latch.isOF_enable())
		{
			...
			switch(inst_code)
			{
				...
				case 28:
					...
					// check for errors
					if (checkError(inst_ex, arg1, arg2))
						error_instruction = true;
					if (checkError(inst_ma, arg1, arg2))
						error_instruction = true;
					if (checkError(inst_rw, arg1, arg2))
						error_instruction = true;
					if (checkErrorWithDivision(arg1, arg2))
						error_instruction = true;
				...
				default:
					...
					if (checkError(inst_ex, regNo, regNo))
						error_instruction = true;
					if (checkError(inst_ma, regNo, regNo))
						error_instruction = true;
					if (checkError(inst_rw, regNo, regNo))
						error_instruction = true;
					if (checkErrorWithDivision(regNo, regNo))
						error_instruction = true;
