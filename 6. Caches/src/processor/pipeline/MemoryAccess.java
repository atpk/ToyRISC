...
public class MemoryAccess implements Element{
	...
	public void performMA()
	{
		...
		{
			MA_RW_Latch.setoptype(EX_MA_Latch.getoptype());	/* passing optype to next stage */
			/* for verification and visualization purpose */
			
			//System.out.println("MA -> "+EX_MA_Latch.getoptype());
	...
	public void handleEvent(Event e)
	{
			...
			EX_MA_Latch.setMA_enable(false); /* Enabling MA stage */
